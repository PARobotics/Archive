...
#define BAT_LONG_PULL_VCMD1 60      // adjust how much juice to put it
...
#define BAT_LONG_PULL_REV_HOLDTMAX  60   // used for estimte dtMore
...
// IMPORTANT PRGSKILL PARAMETERS
int BAT_CONT_HOLD_IN_BTW       = 100;    // the hold time using hold_V before
