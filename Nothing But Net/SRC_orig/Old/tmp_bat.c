...
void bat_pull_long()
{
  ...
  // BAT_LONG_PULL_ANG_DELTA = BAT_LONG_PULL_ANG_MAX-BAT_LONG_PULL_ANG_MAX_BASE;
  // int ang2 = BAT_LONG_PULL_ANG2+BAT_LONG_PULL_ANG_DELTA/2;       // move the loaded area with MAX
