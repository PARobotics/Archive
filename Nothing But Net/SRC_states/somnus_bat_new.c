...
void bat_hit(int v, int dt)
{
  ...
  while (true) {
    ...
    // {
      ...
      // v_hit = bound(v_hit,10, 127);                // if stuck, I don't think takes more than extran  120 msec
  ...
  // if (AUTO_ADJUST==ON && BAT_CMD==CONTINUOUS) {
    ...
    {
      BAT_SKILLS_HIT_V += SKILLS_BAT_INC1;
